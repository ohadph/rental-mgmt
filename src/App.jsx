              ...
              {editKey===k?(
                ...
                <div>
                  ...
                  <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
                    ...
                    {!readonly&&!b.paid&&<button onClick={()=>{if(window.confirm("למחוק את החשבון?"))deleteBill(k);}} style={{...S.btn("#2a0a0a","#e85c4a"),fontSize:11}}>🗑 מחק</button>}
...
export default function App(){
  ...
  if(!isClaudeEnv){
    ...
    if(!auth.isLoggedIn) return <LoginScreen authStep={auth.authStep} error={auth.error} onSendLink={auth.sendMagicLink} onSignInPassword={auth.signInWithPassword} onGoogleLogin={auth.signInWithGoogle} />;
